...
"""autogenerated by genpy from drone_msgs/PositionCommand.msg. Do not edit."""
import codecs
import sys
...
class PositionCommand(genpy.Message):
  _md5sum = "318e3afd0f777eba510b4c6eb566c6da"
  _type = "drone_msgs/PositionCommand"
...
float64 z"""
  ...
  _slot_types = ['std_msgs/Header','geometry_msgs/Point','geometry_msgs/Vector3','geometry_msgs/Vector3','float64[3]','float64','float64[3]','float64[3]','uint32','uint8']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_get_struct_3d().pack(*self.yaw))
      _x = self.yaw_dot
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.yaw = _get_struct_3d().unpack(str[start:end])
      start = end
      end += 8
      (self.yaw_dot,) = _get_struct_d().unpack(str[start:end])
      start = end
      end += 24
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.yaw = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=3)
      start = end
      end += 8
      (self.yaw_dot,) = _get_struct_d().unpack(str[start:end])
      start = end
