// Generated by gencpp from file drone_msgs/PositionCommand.msg
// DO NOT EDIT!


#ifndef DRONE_MSGS_MESSAGE_POSITIONCOMMAND_H
#define DRONE_MSGS_MESSAGE_POSITIONCOMMAND_H
...
struct PositionCommand_
{
  ...
  _acceleration_type acceleration;
   ...
   typedef boost::array<double, 3>  _yaw_type;
  _yaw_type yaw;
...
// reducing the odds to have name collisions with Windows.h 
...
#endif
#if defined(_WIN32) && defined(TRAJECTORY_STATUS_EXEC)
  #undef TRAJECTORY_STATUS_EXEC
#endif
  ...
  typedef boost::shared_ptr< ::drone_msgs::PositionCommand_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::drone_msgs::PositionCommand_<ContainerAllocator> const> ConstPtr;

}; // struct PositionCommand_

typedef ::drone_msgs::PositionCommand_<std::allocator<void> > PositionCommand;

typedef boost::shared_ptr< ::drone_msgs::PositionCommand > PositionCommandPtr;
typedef boost::shared_ptr< ::drone_msgs::PositionCommand const> PositionCommandConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::drone_msgs::PositionCommand_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::drone_msgs::PositionCommand_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::drone_msgs::PositionCommand_<ContainerAllocator1> & lhs, const ::drone_msgs::PositionCommand_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::drone_msgs::PositionCommand_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::drone_msgs::PositionCommand_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::drone_msgs::PositionCommand_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::drone_msgs::PositionCommand_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::drone_msgs::PositionCommand_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::drone_msgs::PositionCommand_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::drone_msgs::PositionCommand_<ContainerAllocator> >
{
  ...
  static const char* value(const ::drone_msgs::PositionCommand_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x318e3afd0f777ebaULL;
  static const uint64_t static_value2 = 0x510b4c6eb566c6daULL;
};

template<class ContainerAllocator>
struct DataType< ::drone_msgs::PositionCommand_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::drone_msgs::PositionCommand_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::drone_msgs::PositionCommand_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::drone_msgs::PositionCommand_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::drone_msgs::PositionCommand_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // DRONE_MSGS_MESSAGE_POSITIONCOMMAND_H
