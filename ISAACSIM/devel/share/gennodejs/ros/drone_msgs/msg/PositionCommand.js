...
class PositionCommand {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    if (obj.yaw.length !== 3) {
      throw new Error('Unable to serialize array field yaw - length must be 3')
    }
    // Serialize message field [yaw]
    bufferOffset = _arraySerializer.float64(obj.yaw, buffer, bufferOffset, 3);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.yaw = _arrayDeserializer.float64(buffer, bufferOffset, 3)
  ...
  static datatype() {
    ...
    return 'drone_msgs/PositionCommand';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '318e3afd0f777eba510b4c6eb566c6da';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.yaw !== undefined) {
      ...
      resolved.yaw = new Array(3).fill(0)
    }
